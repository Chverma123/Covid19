...
<div class="main_header">
	<div class="row w-100 h-100">
		<div class="col-lg-5 col-m-5 col-12 order-lg-1 order-2">
			<div class="leftside w-100 h-100 d-flex justify-content-center align-items-center">
				<img src="eksath.png" width="300" height="300">
			</div>
			
		</div>
		<div class="col-lg-7 col-m-7 col-12 order-lg-2 order-1">
			<div class="rightside w-100 h-100 d-flex justify-content-center align-items-center">
				<h1>Let's Stay Safe & Fight Together Against Cor <span class="corona_rotate"><img src="corona.png" width="65" height="65"></span> na Virus</h1>
...
<div class="container-fluid sub_section pt-5 pb-5"  id="aboutid">
	...
	<div class="row pt-5">
		<div class="col-lg-5 col-md-6 col-12 ml-5 about_res">
			<img src="aboutcorona.png" class="img-fluid">
		</div>
...
<div class="container-fluid  pt-5 pb-5"  id="sympid">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-12 mt-5">
				<figure class="text-center">
				<img src="nose.png" class="img-fluid" width="120" height="120">
			...
			<div class="col-lg-4 col-md-4 col-12 mt-3">
				<figure class="text-center">
				<img src="fever.jpg" class="img-fluid" width="120" height="120">
			...
			<div class="col-lg-4 col-md-4 col-12 mt-5">
				<figure class="text-center">
				<img src="tired.png" class="img-fluid" width="120" height="120">
		...
		<div class="row">
			<div class="col-lg-4 col-md-4 col-12 mt-5">
				<div class="row">
					<div class="col-lg-4 col-md-4 col-12">
						<figure>
						<img src="handwash.svg" class="img-fluid" width="90" height="90">
						</figure>
					</div>
			...
			<div class="col-lg-4 col-md-4 col-12 mt-5">
				<div class="row">
					<div class="col-lg-4 col-md-4 col-12">
						<figure>
						<img src="dist.png" class="img-fluid" width="90" height="90">
						</figure>
					</div>
			...
			<div class="col-lg-4 col-md-4 col-12 mt-5">
				<div class="row">
					<div class="col-lg-4 col-md-4 col-12">
						<figure>
						<img src="home.png" class="img-fluid" width="90" height="90">
						</figure>
					</div>

					<div class="col-lg-8 col-md-8 col-12">
						<p>Stay home and self-isolate from others in te household if you feel unwell</p>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-4 col-12 mt-5">
				<div class="row">
					<div class="col-lg-4 col-md-4 col-12">
						<figure>
						<img src="news.png" class="img-fluid" width="90" height="90">
						</figure>
					</div>
			...
			<div class="col-lg-4 col-md-4 col-12 mt-5">
				<div class="row">
					<div class="col-lg-4 col-md-4 col-12">
						<figure>
						<img src="care.png" class="img-fluid" width="90" height="90">
						</figure>
					</div>
  	...
  	$.get("https://api.covid19api.com/summary",
          ...
          function (data){
           ...
           for (var i = 1; i < (data['Countries'].length); i++){
             ...
             tbval.rows[i].cells[5].style.background = '#9cc580';
